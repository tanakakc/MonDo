  ...
  private
    ...
    def pre_signup
      ...
      mail = Mail.new do
        ...
        from     MAIL_SECRET[:email] unless defined?(MAIL_SECRET) == nil
        from     ENV["SMTP_USERNAME"] if defined?(MAIL_SECRET) == nil
        to       user.email
      ...
      mail.delivery_method(:smtp,
        ...
        user_name:       MAIL_SECRET[:email] unless defined?(MAIL_SECRET) == nil,
        user_name:       ENV["SMTP_USERNAME"] if defined?(MAIL_SECRET) == nil,
        password:        MAIL_SECRET[:password] unless defined?(MAIL_SECRET) == nil
        password:        ENV["SMTP_PASSWD"] if defined?(MAIL_SECRET) == nil
      )
